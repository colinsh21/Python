# -*- coding: utf-8 -*-
"""
Created on Wed Jan 13 09:56:50 2016
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 06 08:55:35 2016
                    ...
                    for obj in self.p[sys][e][col]:
                        for y in self.p[sys][e][col][obj]:
                            for i in xrange(len(self.p[sys][e][col][obj][y])):
                                ...
                                if self.p[sys][e][col][obj][y][i]<0.001:
                                    self.p[sys][e][col][obj][y][i]=0.001
...
#                    self.p[sys][n][col][1]['b'][b]+=add[1]
    ...
    def step(self):
        ...
        #for a_id in pareto_id:
            #self.ants.append(self.ant_by_id(a_id))
