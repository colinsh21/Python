...
class Space(object):
    ...
    def visualize_system_single(self,system,s,s_mag,t,t_mag,area,score):
        """
        ...
        for i in xrange(2):
            ...
            for e in system[i].edges():
                cap[i][e]=system[i][e[0]][e[1]]['capacity']
        #print cap
        ...
        f = plt.figure(num=None, figsize=(7,7), dpi=1000)
        plt.axis('off')
        plt.xlim(-xmax, xmax)
        plt.ylim(-ymax, ymax)
